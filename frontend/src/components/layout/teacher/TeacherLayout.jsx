...
import AdminHeader from './TeacherHeader';
import AdminSidebar from './TeacherSidebar';
...
const TeacherLayout = () => {
  ...
  useEffect(() => {
    const checkAuth = () => {
      ...
      if (!auth) {
        console.log('[TeacherLayout] Not authenticated, redirecting to /');
        navigate('/', { replace: true });
      }
      
      // Check if user has teacher role
      if (auth && currentUser?.role !== 'teacher') {
        console.log('[TeacherLayout] Not teacher, redirecting to /teacher/dashboard');
